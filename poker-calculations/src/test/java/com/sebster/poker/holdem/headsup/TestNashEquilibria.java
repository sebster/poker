...
public class TestNashEquilibria {
	...
	public void testNashEquilibria() {
		for (final Rational r : NashEquilibria.getRs()) {
			...
			System.out.println("Specified EV      = " + nashEv + " (" + nashEv.decimalValue() + ")");
			System.out.println("Computed EV       = " + computedEv + " (" + computedEv.decimalValue() + ")");
			System.out.println("EV against opt BB = " + optSBEv + " (" + optSBEv.decimalValue() + ")");
			System.out.println("EV against opt SB = " + optBBEv + " (" + optBBEv.decimalValue() + ")");
