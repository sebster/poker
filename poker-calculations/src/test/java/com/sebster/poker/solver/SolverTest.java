...
public class SolverTest {
	...
	public void testEV() {
		...
		Assert.assertEquals(new Rational(-1, 2), Solver.computeSBEV(emptyStrategy, fullStrategy, new Rational(10)));
		Assert.assertEquals(new Rational(1), Solver.computeSBEV(fullStrategy, emptyStrategy, new Rational(10)));
	}
	...
	public void testSolver() {
		...
		Assert.assertEquals(callRange, Solver.optimalBBStrategy(pushRange, new Rational(10)));
		...
		Assert.assertEquals(pushRange, Solver.optimalSBStrategy(callRange, new Rational(10)));
	}
