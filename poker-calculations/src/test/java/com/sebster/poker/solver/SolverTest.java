...
public class SolverTest {
	...
	public void testEV() {
		...
		Assert.assertEquals(new Rational(-1, 2), RationalBestResponseSolver.computeSBEV(emptyStrategy, fullStrategy, new Rational(10)));
		Assert.assertEquals(new Rational(1), RationalBestResponseSolver.computeSBEV(fullStrategy, emptyStrategy, new Rational(10)));
	}
	...
	public void testSolver() {
		...
		Assert.assertEquals(callRange, RationalBestResponseSolver.optimalBBStrategy(pushRange, new Rational(10)));
		...
		Assert.assertEquals(pushRange, RationalBestResponseSolver.optimalSBStrategy(callRange, new Rational(10)));
	}
