 ...
 * ------------------------ */
   ...
   */
   ...
   // Use a "left-looking", dot-product, Crout/Doolittle algorithm.
      ...
      pivsign = 1;
      Rational[] LUrowi;
      Rational[] LUcolj = new Rational[m];
      ...
      for (int j = 0; j < n; j++) {
         ...
         if (p != j) {
            for (int k = 0; k < n; k++) {
               Rational t = LU[p][k]; LU[p][k] = LU[j][k]; LU[j][k] = t;
            }
 ...
 * ------------------------ */
   ...
   */
   ...
   public Rational det () {
      ...
      Rational d = new Rational(pivsign);
      for (int j = 0; j < n; j++) {
         d = d.multiply(LU[j][j]);
      }
      return d;
